...
authentication = flask.Blueprint('authentication', __name__)
...
@authentication.route('/google/login')
@no_cache
def login():
...
@authentication.route('/google/auth')
@no_cache
...
@authentication.route('/google/logout')
@no_cache
def logout():
